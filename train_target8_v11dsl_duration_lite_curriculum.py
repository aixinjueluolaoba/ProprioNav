...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=10_341_000)
    parser.add_argument("--eval-seed-base", type=int, default=10_351_000)
    ...
    if tiny_mode:
        ...
        stage_episodes = int(args.stage_episodes or (500 if quick_mode else 2_000))
        eval_episodes = int(args.eval_episodes or (6 if quick_mode else 20))
    ...
    csv_path = output_dir / "v11dsl_curriculum_results.csv"
    md_path = output_dir / "v11dsl_curriculum_results.md"
