...
DEFAULT_EXPERIMENT = "rppo_medium_lstm128x2_observable12_target8_macro_library_v11tm_stage2"
DEFAULT_STATE_MODE = "observable12_target8_macro_library_v11tm_stage2"
...
def main() -> None:
    ...
    parser.add_argument("--max-checkpoint", type=int, default=1_000)
