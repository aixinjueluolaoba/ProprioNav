...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=11_151_000)
    parser.add_argument("--eval-seed-base", type=int, default=11_161_000)
    ...
    if tiny_mode:
        ...
        stage_episodes = int(args.stage_episodes or (125 if quick_mode else 250))
        eval_episodes = int(args.eval_episodes or (6 if quick_mode else 8))
        checkpoint_interval = int(args.checkpoint_interval or (64 if quick_mode else 125))
        progress_interval = int(args.progress_interval or (32 if quick_mode else 64))
    ...
    csv_path = output_dir / "v11rxc_pressure_seed_curriculum_results.csv"
    md_path = output_dir / "v11rxc_pressure_seed_curriculum_results.md"
