...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=9_810_000)
    parser.add_argument("--eval-seed-base", type=int, default=9_910_000)
    ...
    csv_path = output_dir / "v10b9_curriculum_results.csv"
    md_path = output_dir / "v10b9_curriculum_results.md"
    ...
    for idx, exp in enumerate(selected_stages):
        ...
        try:
            ...
            print(
                f"v10b9_stage_start stage={global_stage_idx + 1}/{len(STAGES)} "
            ...
            if prev_model is None:
                ...
                print(f"v10b9_stage_resume model={prev_model}", flush=True)
            ...
            print(f"v10b9_stage_done name={exp.name}", flush=True)
        finally:
            if env is not None:
                env.close()
    ...
    print("v10b9_curriculum_done", flush=True)
