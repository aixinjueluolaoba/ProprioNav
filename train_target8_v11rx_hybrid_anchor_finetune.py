...
from train_target8_v11rx_bad_seed_curriculum import make_bad_seed_env, parse_seed_pool
...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=10_941_000)
    parser.add_argument("--eval-seed-base", type=int, default=10_951_000)
    ...
    csv_path = output_dir / "v11rx_hybrid_anchor_results.csv"
    md_path = output_dir / "v11rx_hybrid_anchor_results.md"
