...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=10_541_000)
    parser.add_argument("--eval-seed-base", type=int, default=10_551_000)
    ...
    csv_path = output_dir / "v11tm_curriculum_results.csv"
    md_path = output_dir / "v11tm_curriculum_results.md"
