...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=11_021_000)
    parser.add_argument("--eval-seed-base", type=int, default=11_031_000)
    ...
    csv_path = output_dir / "continuous_fixed_recovery_v5_results.csv"
    md_path = output_dir / "continuous_fixed_recovery_v5_results.md"
