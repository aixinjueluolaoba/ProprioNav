...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=10_971_000)
    parser.add_argument("--eval-seed-base", type=int, default=10_981_000)
    ...
    csv_path = output_dir / "v11rx_bad_seed_curriculum_results.csv"
    md_path = output_dir / "v11rx_bad_seed_curriculum_results.md"
