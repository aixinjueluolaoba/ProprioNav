...
DEFAULT_EXPERIMENT = "rppo_medium_lstm128x2_observable12_target8_discrete_recovery_v10b9_stage3"
DEFAULT_STATE_MODE = "observable12_target8_discrete_recovery_v10b9_stage3"
CURRICULUM_STAGES = [
    (
        "stage1",
        "rppo_medium_lstm128x2_observable12_target8_discrete_recovery_v10b9_stage1",
        "observable12_target8_discrete_recovery_v10b9_stage1",
        20_000,
    ),
    (
        "stage2a",
        "rppo_medium_lstm128x2_observable12_target8_discrete_recovery_v10b9_stage2a",
        "observable12_target8_discrete_recovery_v10b9_stage2a",
        10_000,
    ),
    (
        "stage2",
        "rppo_medium_lstm128x2_observable12_target8_discrete_recovery_v10b9_stage2",
        "observable12_target8_discrete_recovery_v10b9_stage2",
        30_000,
    ),
    (
        "stage3",
        "rppo_medium_lstm128x2_observable12_target8_discrete_recovery_v10b9_stage3",
...
def curriculum_entries(args: argparse.Namespace) -> list[tuple[str, str, str, int]]:
    ...
    stage3_model_dir = Path(args.run_dir) / DEFAULT_EXPERIMENT / "models"
    if stage3_model_dir.exists():
        has_any = any(stage3_model_dir.glob("checkpoint_ep_*.zip"))
