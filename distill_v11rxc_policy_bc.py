...
def map_actions_to_v11rxc(actions: np.ndarray, action_format: str, remap_macro4_to_7: bool) -> np.ndarray:
    ...
    if action_format in {"v11rxc", "v11rx"}:
...
def main() -> None:
    ...
    dataset_action_formats = ["v11rxc"] * len(dataset_paths)
