...
def main() -> None:
    ...
    parser.add_argument("--stage-episodes", type=int, default=2_000)
    parser.add_argument("--n-envs", type=int, default=N_ENVS)
    parser.add_argument("--eval-episodes", type=int, default=20)
    parser.add_argument("--video-episodes", type=int, default=0)
    parser.add_argument("--device", default="cpu")
    parser.add_argument("--torch-threads", type=int, default=1)
    parser.add_argument("--seed-base", type=int, default=10_241_000)
    parser.add_argument("--eval-seed-base", type=int, default=10_251_000)
    ...
    csv_path = output_dir / "v11ds_curriculum_results.csv"
    md_path = output_dir / "v11ds_curriculum_results.md"
    ...
    try:
        print(f"v11ds_stage_start name={STAGE.name} n_envs={int(args.n_envs)}", flush=True)
        env = SubprocVecEnv(
        ...
        model.learn(
            total_timesteps=int(args.stage_episodes) * MAX_STEPS,
            callback=callback,
            progress_bar=False,
        ...
        row: dict[str, object] = {
            ...
            "trained_episodes": int(args.stage_episodes),
