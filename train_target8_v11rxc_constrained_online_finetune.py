...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=11_081_000)
    parser.add_argument("--eval-seed-base", type=int, default=11_091_000)
    ...
    parser.add_argument("--trainable-param-mode", default="macro_slice_only")
    ...
    csv_path = output_dir / "v11rxc_constrained_online_finetune_results.csv"
    md_path = output_dir / "v11rxc_constrained_online_finetune_results.md"
