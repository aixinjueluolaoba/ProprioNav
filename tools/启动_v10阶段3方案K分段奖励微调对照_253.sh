...
RUN_GROUP_NAME=${RUN_GROUP_NAME:-目标8显式脱困v10阶段3方案K分段奖励微调对照_253}
...
VARIANT_NAMES=${VARIANT_NAMES:-方案S_K分段压角|方案T_K分段轻压角|方案U_K分段保守压角}
ENV_OVERRIDES_FILES=${ENV_OVERRIDES_FILES:-$ROOT/configs/v10_stage3/方案S_K分段压角.json|$ROOT/configs/v10_stage3/方案T_K分段轻压角.json|$ROOT/configs/v10_stage3/方案U_K分段保守压角.json}
SEED_BASE_START=${SEED_BASE_START:-14555000}
