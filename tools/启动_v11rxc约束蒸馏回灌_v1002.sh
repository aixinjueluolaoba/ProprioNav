...
RUN_NAME=${RUN_NAME:-v11rxc_distill_mergeback_macro_slice}
RUN_DIR=${RUN_DIR:-$REMOTE_ROOT/runs/$RUN_NAME}
DATA_DIR=$RUN_DIR/teacher_datasets
BASE_MODEL=${BASE_MODEL:-$REMOTE_ROOT/runs/v11rxc_two_stage_6300031push112_tail2_N2stabilize32/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rxc_stage2/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rxc_stage2.zip}
...
SPECIALIST_MODEL=${SPECIALIST_MODEL:-$REMOTE_ROOT/runs/v11rxc_nlite125_fix6300031_targeted_far6_stuck10_rl125/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rxc_stage2/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rxc_stage2.zip}
...
SPECIALIST_DATASET=$DATA_DIR/坏种子6300031修复轨迹_v11rxc.npz
...
DATASET_WEIGHTS=${DATASET_WEIGHTS:-1.0,1.2,1.8}
...
for required in "$BASE_MODEL" "$NORMAL_MODEL" "$PRESSURE_MODEL" "$SPECIALIST_MODEL"; do
...
ssh v1002 "cd '$REMOTE_ROOT' && source ~/miniconda3/etc/profile.d/conda.sh && conda activate ML && python eval_target8_sweep.py \
  ...
  --model-path '$RUN_DIR/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rxc_stage2' \
