...
RUN_DIR=${RUN_DIR:-$ROOT/runs/连续10维固定脱困直线优先_253_10k}
EXPERIMENT=${EXPERIMENT:-rppo_small_lstm128x1_observable10_target8_continuous_fixed_recovery_v4}
...
SEED_BASE=${SEED_BASE:-9992000}
EVAL_SEED_BASE=${EVAL_SEED_BASE:-9993000}
