...
RUN_NAME=${RUN_NAME:-v11rxc_tiny64_diag4_then_n9_mergeback}
...
PHASE1_OVERRIDES=${PHASE1_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N9_v11rxc近N6但wrapper不注入macro6评估探针.json}
PHASE2_OVERRIDES=${PHASE2_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N9_v11rxc近N6但wrapper不注入macro6评估探针.json}
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N9_v11rxc近N6但wrapper不注入macro6评估探针.json}
PHASE1_SEED_POOL=${PHASE1_SEED_POOL:-6300031,6300058,6300069,6300006}
PHASE2_SEED_POOL=${PHASE2_SEED_POOL:-6300031,6300058,6300069,6300006}
PHASE1_EPISODES=${PHASE1_EPISODES:-16}
PHASE2_EPISODES=${PHASE2_EPISODES:-32}
PHASE2_BAD_SEED_RATIO=${PHASE2_BAD_SEED_RATIO:-0.0}
