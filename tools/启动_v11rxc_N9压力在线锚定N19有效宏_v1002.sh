...
RUN_NAME=${RUN_NAME:-v11rxc_n9_pressure_anchor_n19_effective_tiny}
...
PRESSURE_SPECIALIST_DATASET=$DATA_DIR/压力专科轨迹_N19_effective_v11rxc.npz
NORMAL_SEED_START=${NORMAL_SEED_START:-1810000}
NORMAL_EPISODES=${NORMAL_EPISODES:-24}
PRESSURE_SPECIALIST_SEEDS=${PRESSURE_SPECIALIST_SEEDS:-5200015,5200015,5200015,5200015,5200008,5200022}
...
ANCHOR_DATASET_WEIGHTS=${ANCHOR_DATASET_WEIGHTS:-1.0,2.4}
RECOVERY_WEIGHT=${RECOVERY_WEIGHT:-1.35}
STUCK_WEIGHT=${STUCK_WEIGHT:-1.2}
COLLISION_WEIGHT=${COLLISION_WEIGHT:-1.15}
PPO_LEARNING_RATE=${PPO_LEARNING_RATE:-2e-5}
ANCHOR_LEARNING_RATE=${ANCHOR_LEARNING_RATE:-1e-4}
ANCHOR_TRAINABLE_PARAM_MODE=${ANCHOR_TRAINABLE_PARAM_MODE:-action_net_only}
