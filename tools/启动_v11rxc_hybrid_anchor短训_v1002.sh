...
RUN_NAME=${RUN_NAME:-v11rxc_hybrid_anchor_n2pull_tiny}
...
SPECIALIST_MODEL=${SPECIALIST_MODEL:-$REMOTE_ROOT/runs/v11rxc_nlite125_fix6300031_targeted_far6_stuck10_search112/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rxc_stage2/models/checkpoint_ep_00112.zip}
...
ANCHOR_DATASET_WEIGHTS=${ANCHOR_DATASET_WEIGHTS:-1.2,1.4,1.6}
