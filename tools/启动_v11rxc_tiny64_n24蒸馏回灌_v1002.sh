...
RUN_NAME=${RUN_NAME:-v11rxc_tiny64_n24_distill_policyhead}
...
SPECIALIST_OVERRIDES_REMOTE=${SPECIALIST_OVERRIDES_REMOTE:-$REMOTE_ROOT/configs/v11/方案N24_v11rxc近N9加远距targeted_far6评估探针.json}
