...
RUN_NAME=${RUN_NAME:-v11rxc_two_stage_6300031push112_tail2_rewardpen32}
...
PHASE2_OVERRIDES=${PHASE2_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N4_v11rxc尾部显式恢复惩罚探针.json}
...
copy_file "configs/v11/方案N4_v11rxc尾部显式恢复惩罚探针.json"
