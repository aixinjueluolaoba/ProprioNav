...
RUN_NAME=${RUN_NAME:-v11rxc_ep112_releasegate_fix6300069_rl64}
...
TRAIN_OVERRIDES=${TRAIN_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N5_v11rxc策略宏需释放评估探针.json}
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案Nlite_v11rxc尾部轻保守探针.json}
SEED_POOL=${SEED_POOL:-6300069}
