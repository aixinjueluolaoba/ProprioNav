...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N21_v11rxc中距抑制宏6长链放行评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_mid_macro6_passthrough_eval}
...
copy_file "configs/v11/方案N21_v11rxc中距抑制宏6长链放行评估探针.json"
