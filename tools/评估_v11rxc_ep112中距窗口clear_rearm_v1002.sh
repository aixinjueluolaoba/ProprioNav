...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N11_v11rxc中距窗口clear_rearm评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_midband_rearm_eval}
...
copy_file "configs/v11/方案N11_v11rxc中距窗口clear_rearm评估探针.json"
