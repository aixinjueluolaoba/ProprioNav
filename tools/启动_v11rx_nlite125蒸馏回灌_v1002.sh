...
RUN_NAME=${RUN_NAME:-v11rx_nlite125_distill_mergeback}
RUN_DIR=${RUN_DIR:-$REMOTE_ROOT/runs/$RUN_NAME}
DATA_DIR=$RUN_DIR/teacher_datasets
BASE_MODEL=${BASE_MODEL:-$REMOTE_ROOT/runs/v11rx_tail2_conservative_lite_125/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rx_stage2/models/checkpoint_ep_00125.zip}
...
for required in "$BASE_MODEL" "$NORMAL_DATASET" "$PRESSURE_DATASET"; do
