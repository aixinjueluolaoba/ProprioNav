...
RUN_DIR=${RUN_DIR:-$ROOT/runs/目标8显式脱困v10阶段3方案E复验_253}
WATCH_DIR=${WATCH_DIR:-$ROOT/runs/目标8显式脱困v10阶段3方案E复验_checkpoint评估_253}
...
SEED_BASE=${SEED_BASE:-15155000}
EVAL_SEED_BASE=${EVAL_SEED_BASE:-15255000}
