...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N6_v11rxc策略宏释放加脱困重武装评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_clearrearm_eval}
...
copy_file "configs/v11/方案N6_v11rxc策略宏释放加脱困重武装评估探针.json"
