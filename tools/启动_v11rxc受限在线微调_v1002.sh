...
RUN_NAME=${RUN_NAME:-v11rxc_constrained_online_tail2_tiny}
...
ssh v1002 "cd '$REMOTE_ROOT' && source ~/miniconda3/etc/profile.d/conda.sh && conda activate ML && python train_target8_v11rxc_constrained_online_finetune.py \
  $TRAIN_EXTRA_ARGS \
  --output-dir '$RUN_DIR' \
