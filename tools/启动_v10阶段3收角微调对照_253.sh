...
RUN_GROUP_NAME=${RUN_GROUP_NAME:-目标8显式脱困v10阶段3收角微调对照_253}
...
VARIANT_NAMES=${VARIANT_NAMES:-方案I轻压收角|方案J轻压保脱困|方案K中压收角}
ENV_OVERRIDES_FILES=${ENV_OVERRIDES_FILES:-$ROOT/configs/v10_stage3/方案I_轻压收角.json|$ROOT/configs/v10_stage3/方案J_轻压保脱困.json|$ROOT/configs/v10_stage3/方案K_中压收角.json}
SEED_BASE_START=${SEED_BASE_START:-10955000}
