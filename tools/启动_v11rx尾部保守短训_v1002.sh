...
RUN_NAME=${RUN_NAME:-v11rx_tail2_conservative_micro}
...
OVERRIDES_REMOTE=${OVERRIDES_REMOTE:-$REMOTE_ROOT/configs/v11/方案N_v11rx尾部抑激进探针.json}
...
copy_file "configs/v11/方案N_v11rx尾部抑激进探针.json"
