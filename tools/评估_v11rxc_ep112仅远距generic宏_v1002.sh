...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N13_v11rxc仅远距generic宏评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_far_generic_only_eval}
...
copy_file "configs/v11/方案N13_v11rxc仅远距generic宏评估探针.json"
