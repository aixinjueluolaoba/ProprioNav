...
RUN_NAME=${RUN_NAME:-v11rx_conflict4_micro}
RUN_DIR=${RUN_DIR:-$REMOTE_ROOT/runs/$RUN_NAME}
RESUME_MODEL=${RESUME_MODEL:-$REMOTE_ROOT/runs/v11rx_6300069_quick/rppo_medium_lstm128x2_observable12_target8_macro_library_v11rx_stage2/models/checkpoint_ep_00250.zip}
OVERRIDES_REMOTE=${OVERRIDES_REMOTE:-$REMOTE_ROOT/configs/v11/方案M_v11rx短左回正探针.json}
SEED_POOL=${SEED_POOL:-6300069,6300058,6300031,6300006}
