...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N8_v11rxc释放后仅近距重武装评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_near_rearm_eval}
...
copy_file "configs/v11/方案N8_v11rxc释放后仅近距重武装评估探针.json"
