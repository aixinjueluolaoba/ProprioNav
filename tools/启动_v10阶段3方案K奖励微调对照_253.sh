...
RUN_GROUP_NAME=${RUN_GROUP_NAME:-目标8显式脱困v10阶段3方案K奖励微调对照_253}
...
VARIANT_NAMES=${VARIANT_NAMES:-方案P_K奖励压角|方案Q_K奖励轻压角|方案R_K奖励保脱困压角}
ENV_OVERRIDES_FILES=${ENV_OVERRIDES_FILES:-$ROOT/configs/v10_stage3/方案P_K奖励压角.json|$ROOT/configs/v10_stage3/方案Q_K奖励轻压角.json|$ROOT/configs/v10_stage3/方案R_K奖励保脱困压角.json}
SEED_BASE_START=${SEED_BASE_START:-13955000}
