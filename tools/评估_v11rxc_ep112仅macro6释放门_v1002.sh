...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N7_v11rxc仅约束macro6释放评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_macro6gate_eval}
...
copy_file "configs/v11/方案N7_v11rxc仅约束macro6释放评估探针.json"
