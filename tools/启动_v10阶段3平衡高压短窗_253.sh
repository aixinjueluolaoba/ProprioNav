...
RUN_DIR=${RUN_DIR:-$ROOT/runs/目标8显式脱困v10阶段3平衡高压短窗_253}
WATCH_DIR=${WATCH_DIR:-$ROOT/runs/目标8显式脱困v10阶段3平衡高压短窗_checkpoint评估_253}
...
STAGE3_EPISODES=${STAGE3_EPISODES:-1000}
N_ENVS=${N_ENVS:-96}
THREADS=${THREADS:-1}
DEVICE=${DEVICE:-cpu}
EVAL_EPISODES=${EVAL_EPISODES:-20}
VIDEO_EPISODES=${VIDEO_EPISODES:-0}
SEED_BASE=${SEED_BASE:-9845000}
EVAL_SEED_BASE=${EVAL_SEED_BASE:-9945000}
