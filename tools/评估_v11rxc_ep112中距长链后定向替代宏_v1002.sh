...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N18_v11rxc中距长链后定向替代宏评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_mid_generic_tail_targeted_eval}
...
copy_file "configs/v11/方案N18_v11rxc中距长链后定向替代宏评估探针.json"
