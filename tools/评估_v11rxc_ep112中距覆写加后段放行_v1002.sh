...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N23_v11rxc中距覆写加后段放行评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_mid_override_plus_late_passthrough_eval}
...
copy_file "configs/v11/方案N23_v11rxc中距覆写加后段放行评估探针.json"
