...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N12_v11rxc中距单次clear_rearm评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_midband_single_rearm_eval}
...
copy_file "configs/v11/方案N12_v11rxc中距单次clear_rearm评估探针.json"
