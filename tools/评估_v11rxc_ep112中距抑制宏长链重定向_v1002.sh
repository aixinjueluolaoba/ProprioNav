...
EVAL_OVERRIDES=${EVAL_OVERRIDES:-$REMOTE_ROOT/configs/v11/方案N20_v11rxc中距抑制宏长链重定向评估探针.json}
OUT_PREFIX=${OUT_PREFIX:-$REMOTE_ROOT/runs/v11rxc_ep112_mid_suppressed_redirect_eval}
...
copy_file "configs/v11/方案N20_v11rxc中距抑制宏长链重定向评估探针.json"
