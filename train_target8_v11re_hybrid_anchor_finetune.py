...
from train_target8_v11re_bad_seed_curriculum import make_bad_seed_env, parse_seed_pool
...
def main() -> None:
    ...
    parser.add_argument("--seed-base", type=int, default=10_921_000)
    parser.add_argument("--eval-seed-base", type=int, default=10_931_000)
    ...
    csv_path = output_dir / "v11re_hybrid_anchor_results.csv"
    md_path = output_dir / "v11re_hybrid_anchor_results.md"
    ...
    try:
        ...
        optimizer = torch.optim.Adam(model.policy.parameters(), lr=float(args.anchor_learning_rate))
        total_episodes = 0
